...
//~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~	
   public String outPatientIdGenerator() {
//	   UUID uuid = UUID.randomUUID();
//		String uuidAsString = uuid.toString();
//		String uuid_num[]=uuidAsString.split("-");
//		System.out.println(uuidAsString);
//		String patId="OP_CREATED_"+uuid_num[1].toUpperCase();
	    
    
        Date dNow = new Date();
        SimpleDateFormat ft = new SimpleDateFormat("yyMMddhhmmssMs");
        String datetime = ft.format(dNow);
        //System.out.println("OP_CREATED_"+datetime);
        String patId="OP_CREATED_"+datetime;
	        // IP_CREATED_210722071043743
		return patId;

   }
   
   public String inPatientIdGenerator() {
	   Date dNow = new Date();
       SimpleDateFormat ft = new SimpleDateFormat("yyMMddhhmmssMs");
       String datetime = ft.format(dNow);
       //System.out.println("IP_CREATED_"+datetime);
       String patId="IP_CREATED_"+datetime;
...
//	        wait.until(ExpectedConditions.elementToBeClickable(ele));   
	        ...
	        //ele.click();
	        setReport().log(Status.PASS, "Assert Verified on " + field, screenshotCapture());
	    } catch (InvalidElementStateException e) {
	        e.printStackTrace();
	        setReport().log(Status.FAIL, field + " could not be verfied", screenshotCapture());
	        Driver.failCount++;
	    } catch (WebDriverException e) {
	        e.printStackTrace();
	        setReport().log(Status.FAIL, "Unknown exception occured while assert verfication on " + field,
	                screenshotCapture());
	        Driver.failCount++;
	    }
	}
//~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~	
	public void softAssertVerification(WebElement ele, String field) {
	    try {
	        softAssertion= new SoftAssert();
	        softAssertion.assertEquals(ele.getText(), field);
            
	        
	        setReport().log(Status.PASS, "Soft Assert Verified on " + field, screenshotCapture());
	    ...
	    //catch (WebDriverException e) {
//	        e.printStackTrace();
//	        setReport().log(Status.FAIL, "Unknown exception occured while soft assert verfication on " + field,
//	                screenshotCapture());
//	        Driver.failCount++;
//	    }
	}
